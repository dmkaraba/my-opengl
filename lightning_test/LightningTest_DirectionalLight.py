...
camera = Camera(pos=pyrr.Vector3((0, 0, 4)))
...
light_direction_loc = glGetUniformLocation(light_shader, "light.direction")
...
while not glfw.window_should_close(window):
    ...
    lamp_dir_vector = pyrr.Vector3((-0.2, 1.0, -0.3))
    glUniform3f(light_direction_loc, *lamp_dir_vector)
    glUniform3f(view_pos_loc, *camera.position)

    glUniform3f(light_ambient_loc, 0.2, 0.2, 0.2)
    glUniform3f(light_diffuse_loc, 0.5, 0.5, 0.5)
